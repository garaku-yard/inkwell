    ...
    return (
      <div ref={parentRef} className="flex-1 overflow-auto p-8 bg-gray-100 dark:bg-gray-900">
        <div
          ...
          className="w-[8.27in] min-h-[11.69in] mx-auto bg-white dark:bg-gray-800 shadow-2xl relative font-mono text-base leading-relaxed pt-[1in] pb-[1in] pr-[1in] pl-[1.5in]"
        >
          <div
            style={{
