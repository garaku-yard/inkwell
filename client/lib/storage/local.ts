...
const ai: AiStorage = {
  // AI chat is planned via BYO-key in settings; phase 5 polish will wire it up.
  listProviders: async () => ({ providers: [], config: {} }),
 ...
 *  real login), `collaboration`, `realtime`, `admin`, `ai.hosted`. */
