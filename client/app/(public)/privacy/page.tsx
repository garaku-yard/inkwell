...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy" updated="14 September 2026">
      ...
      <p>
        AI features can use your own provider keys. On the desktop app, keys are
        ...
        your keys anywhere except the provider you configured. When you choose
        managed AI, the writing and instructions needed for your request are sent
        to the provider operated for Inkwell, and token usage is recorded to apply
        your plan allowance.
      </p>
